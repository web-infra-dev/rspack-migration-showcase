import { Link, useLocation, useNavigate, Outlet, matchRoutes } from 'react-router-dom';
import { useAppData } from '@/core/renderClient/appContext';
import type { IRoute } from '@/core/renderClient/types';
...
import { useModel } from '@/core/plugin-model';
import { useAccessMarkedRoutes } from '@/core/plugin-access';
import { useIntl } from '@/core/plugin-locale';
